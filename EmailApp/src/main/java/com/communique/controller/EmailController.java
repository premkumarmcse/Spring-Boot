...
public class EmailController {
	...
	public String sendEmail(@RequestBody EmailRequest emailRequest) {
		return sendGridEmailService.sendHTML(emailRequest);
	}
	
	@PostMapping(value="/sendBulkEmail")
	public String sendBulkEmail(@RequestBody EmailRequest emailRequest) {
		return sendGridEmailService.sendBulkEmail(emailRequest);
	}
